...
Route::middleware('auth', 'verified')->prefix('admin')->group(function(){
    ...
    Route::middleware('can:admin-users')->group(function(){
        Route::resource('users', UsersC::class)->parameters(['users' => 'id'])->middleware('can:admin-users');
    ...
    Route::resource('tags', TagsC::class)->parameters(['tags' => 'id'])->middleware('can:admin-tags');
